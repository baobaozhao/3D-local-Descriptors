 function Hist_out=XZ_spatial(pointcloud,Key_indices,R,X_size,Z_size,LRFs)
...
%  output:Hist_out - the vectors of XZ_spatial descriptor generated on all key pointcloud.
