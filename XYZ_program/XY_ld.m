 function Hist_out=XY_ld(pointcloud,Key_indices,LPAs,R,X_size,Y_size,deviation_angle_size,LRFs)
...
%  output:Hist_out - the vectors of XY_ld descriptor generated on all key pointcloud.
...
for i=1:L_key_points
    ...
    %Normal_length(j)=local_points(j,:)*LRA';
        ...
        index=(X_list-1)*Y_size*deviation_angle_size+(Y_list-1)*deviation_angle_size+deviation_angle_list;
