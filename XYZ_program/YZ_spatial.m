 function Hist_out=YZ_spatial(pointcloud,Key_indices,R,Y_size,Z_size,LRFs)
...
%  output:Hist_out - the vectors of YZ_spatial descriptor generated on all key pointcloud.
