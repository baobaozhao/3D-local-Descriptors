function Hist_out=azimuth_ld(pointcloud,Key_indices,LPAs,R,azimuth_angle_size,deviation_angle_size,LRFs)
...
%  output:Hist_out - the vectors of azimuth_ld descriptor generated on all key pointcloud.

L_key_points=length(Key_indices);
hist_size=azimuth_angle_size*deviation_angle_size;
...
%Z_step=180/Z_angle_size; %  与xy平面之间的夹角计算。
...
for i=1:L_key_points
    ...
    for j=1:neigh_size
        ...
        index=(azimuth_angle_list-1)*deviation_angle_size+deviation_angle_list;
