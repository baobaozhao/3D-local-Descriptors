function Hist_out=radial_azimuth_ld(pointcloud,Key_indices,LPAs,R,radial_size,azimuth_angle_size,deviation_angle_size,LRFs)
...
%  output:Hist_out - the vectors of radial_azimuth_ld descriptor generated on all key pointcloud.
...
for i=1:L_key_points
    ...
    %Normal_length(j)=local_points(j,:)*LRA';
        ...
        index=(radial_list-1)*azimuth_angle_size*deviation_angle_size+(azimuth_angle_list-1)*deviation_angle_size+deviation_angle_list;
