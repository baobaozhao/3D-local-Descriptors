function Hist_out=radial_elevation(pointcloud,Key_indices,R,radial_size,elevation_angle_size,LRFs)
...
%  output:Hist_out - the vectors of radial_elevation descriptor generated on all key pointcloud.
...
%         elevation_angle_list
        ...
        index=(radial_list-1)*elevation_angle_size+elevation_angle_list;
