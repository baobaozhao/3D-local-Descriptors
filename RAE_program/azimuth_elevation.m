function Hist_out=azimuth_elevation(pointcloud,Key_indices,R,azimuth_angle_size,elevation_angle_size,LRFs)
...
%  output:Hist_out - the vectors of azimuth_elevation descriptor generated on all key pointcloud.
...
%         end
        ...
        index=(azimuth_angle_list-1)*elevation_angle_size+elevation_angle_list;
